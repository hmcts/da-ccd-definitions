...
module.exports = {
  ...
  async fillHasAttendedMIAMPage () {
    ...
    await I.waitForElement('//input[@id="DAMediatorMIAM_Yes"]')
    await I.checkOption('//input[@id="DAMediatorMIAM_Yes"]')
  ...
  async fillMIAMCertificationPage () {
    ...
    await I.fillField('//input[@id="DAMediatorServiceName1"]', 'Test service name')
  ...
  async fillHasAttendedMIAMPageDifferentFlow () {
    ...
    await I.waitForElement('//input[@id="ClaimingExemptionMIAM_Yes"]')
    await I.checkOption('//input[@id="ClaimingExemptionMIAM_Yes"]')
    await I.waitForElement('//input[@id="DAMediatorMIAM_No"]')
    await I.checkOption('//input[@id="DAMediatorMIAM_No"]')
    await I.click(this.fields.submit)
  },
