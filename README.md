...
Project creating Domestic Abuse (da) CCD config files.
...
$ yarn --cwd ccd-definition-processor json2xlsx -D ../definitions/da/json -o ../definitions/private-law/xlsx/ccd-config-${TARGET_ENV:-base}.xlsx -e '*-prod.json'
$ node ./bin/json2xlsx -D ../definitions/private-law/json -o ../definitions/da/xlsx/ccd-config-aat.xlsx -e '*-prod.json'
...
Require stack:
- [...]/da-ccd-definitions/ccd-definition-processor/src/main/lib/file-utils.js
- [...]/da-ccd-definitions/ccd-definition-processor/src/main/json2xlsx.js
- [...]/da-ccd-definitions/ccd-definition-processor/bin/json2xlsx.js
